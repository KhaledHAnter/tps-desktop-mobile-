...
Future<bool> showFreezeDeleteConfirmationDialog(BuildContext context) async {
  return await showDialog<bool>(
        context: context,
        builder: (context) {
          return AlertDialog(
            title: Text(S.of(context).actions_freeze_delete_confirm),
            content: Text(S.of(context).actions_freeze_delete_desc),
            actions: [
              TextButton(
                onPressed: () {
